...
<head>
  ...
  <meta name="description" content="website created by https://github.com/ulipese - Felipe Sousa de Oliveira">
  <!-- CSS -->
...
<body>
  ...
  <div class="container-fluid">
    <div class="row content-center">
      <?php
      $query = $cn->query("select ClockImage, ClockName, ClockPrice, ClockQuantity from vwClock");
